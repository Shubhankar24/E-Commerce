              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?<div className="flow-root">
                    ...
                    {user?.user?.email === 'shubhankarobroye@gmail.com'?<div className="flow-root">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://imgs.search.brave.com/2xA8B_p2UVOYqMYitGQOkM74LBJSvx7XsY32PzVMdAA/rs:fit:500:0:0/g:ce/aHR0cHM6Ly93aGF0/bmVyZC5jb20vd3At/Y29udGVudC91cGxv/YWRzLzIwMjEvMTAv/Y29vbGVzdC1hbmlt/ZS1jaGFyYWN0ZXJz/LXdpdGgtbWFzay1h/bmltZS1tYXNrLWRl/c2lnbi1leWVwYXRj/aC1rZW4ta2FuZWtp/LXRva3lvLWdob3Vs/LmpwZw"
                        alt="Shubham" />                                        </Link>
                  </div>
                </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user?.user?.email === "shubhankarobroye@gmail.com"? <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>:""}
